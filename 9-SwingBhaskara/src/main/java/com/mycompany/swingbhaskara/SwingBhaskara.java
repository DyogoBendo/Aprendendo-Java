 ...
 */
package com.mycompany.swingbhaskara;

/**
 *
 * @author Dyogo
 */
public class SwingBhaskara extends javax.swing.JFrame {

    /**
     * Creates new form SwingBhaskara
     */
    public SwingBhaskara() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblA.setForeground(new java.awt.Color(0, 72, 153));
        lblA.setText("A");

        lblB.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lblB.setForeground(new java.awt.Color(0, 72, 153));
        lblB.setText("B");

        lblC.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lblC.setForeground(new java.awt.Color(0, 72, 153));
        lblC.setText("C");
        ...
        jLabel6.setText("Raizes");

        lblDelta.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lblDelta.setForeground(new java.awt.Color(204, 204, 0));
        lblDelta.setText("0");

        lblRaiz.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lblRaiz.setForeground(new java.awt.Color(204, 204, 0));
        lblRaiz.setText("0");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (d < 0){
            lblRaiz.setText("Nao possui raizes reais");
        } else{
            lblRaiz.setText("Possui raizes reais");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SwingBhaskara.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SwingBhaskara().setVisible(true);
            }
        });
    }
