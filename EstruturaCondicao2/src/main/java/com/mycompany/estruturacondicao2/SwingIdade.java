 ...
 * @author Dyogo
 */
public class SwingIdade extends javax.swing.JFrame {

    /**
     * Creates new form SwingIdade
     */
    public SwingIdade() {
        initComponents();
    }
    ...
    private void btnVotarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVotarActionPerformed
        int idade = 2020 - Integer.parseInt(txtAno.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SwingIdade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SwingIdade().setVisible(true);
            }
        });
    }
